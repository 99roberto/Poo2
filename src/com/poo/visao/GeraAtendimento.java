...
public class GeraAtendimento extends IInternalFrame {
	 ...
	 * CPF, o qual ser� utilizado para verificar se o paciente j� possui cadastro
	...
	// i) data e hor�rio da entrada na emergencia,
	private MDateTimeField dtaEntrada;

	// ii) descri��o do problema de sa�de (queixa),
